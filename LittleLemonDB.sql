...
CREATE TABLE `bookings` (
  ...
  CONSTRAINT `bookings_customer_id_fk` FOREIGN KEY (`CustomerID`) REFERENCES `customers` (`CustomerID`)
...
INSERT INTO `bookings` VALUES (1,'2022-10-10',5,5,1),(2,'2022-11-12',3,4,3),(3,'2022-10-11',2,2,2),(4,'2022-10-13',2,3,1),(5,'2022-01-02',2,6,5);
...
INSERT INTO `customers` VALUES (1,'John Doe','463834222','jd@email.com'),(2,'Angela Minkai','5739348433','aminkai@email.com'),(3,'Maria Mueller','1219583944','mariam@email.com'),(4,'Jean Rossini','9709679577','jrossini@email.com'),(5,'Hans Uller','090947472','hansuller@email.com');
...
INSERT INTO `delivery` VALUES (1,'2023-04-20','delivered'),(2,'2023-06-04','delivered'),(3,'2023-05-23','prepared'),(4,'2023-01-22','almost delivered'),(5,'2023-02-11','delivered');
...
INSERT INTO `employees` VALUES (1,'Michael Strumpf','Manager',3400.00),(2,'Carlos Iganzio','Assistant',2400.00),(3,'Cindy Shiller','Chef',2200.00),(4,'Aristoteles Popaiolous','Assistant Chef',2700.00),(5,'Thekla Numina','Assistant',4000.00);
...
INSERT INTO `menuitems` VALUES (1,'Greek salad','Olives','Greek yoghurt'),(2,'Bean soup','Flatbread','Ice cream'),(3,'Pizza','Minestrone','Cheesecake'),(4,'Carbonara','Tomato bread','Affogato'),(5,'Kabasa','Falafel','Turkish yoghurt');
...
INSERT INTO `menus` VALUES (1,'Menu A','Greek',1),(2,'Menu B','Italian',5),(3,'Menu C','Italian',4),(4,'Menu D','Turkish',3),(5,'Menu E','Greek',2);
...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `employee_id_fk` FOREIGN KEY (`EmployeeID`) REFERENCES `employees` (`EmployeeID`),
  CONSTRAINT `menu_id_fk` FOREIGN KEY (`MenuID`) REFERENCES `menus` (`MenuID`),
  CONSTRAINT `orders_customer_id_fk` FOREIGN KEY (`CustomerID`) REFERENCES `customers` (`CustomerID`)
...
INSERT INTO `orders` VALUES (1,'2023-10-13',3,34.60,5,1,5,3,4),(2,'2023-05-18',2,166.50,4,2,4,3,3),(3,'2023-04-17',4,180.30,3,3,3,4,5),(4,'2023-06-11',2,10.60,2,5,2,5,2),(5,'2023-03-14',6,40.70,1,4,1,1,1);
...
-- Dump completed on 2023-11-30 15:02:12
